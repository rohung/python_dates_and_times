...
def start_tracking(client, description, start_time):
...
def display_all_totals(client):
    ...
    for job in client_jobs:
        ...
        start_time = datetime.datetime.strptime(job['start_time'], format_string)
        end_time = datetime.datetime.strptime(job['end_time'], format_string)
        time_spent = relativedelta.relativedelta(end_time, start_time)
        total += time_spent
